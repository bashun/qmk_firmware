...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  \   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Crtl+z| Esc  | Alt  | GUI  |Alt+` |Space | Bksp |RAISE |Enter |LOWER | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      LCTL(KC_Z), KC_ESC,  KC_LALT, KC_LGUI, LALT(KC_GRV), KC_SPC, KC_BSPC,  RAISE,   KC_ENT,  LOWER,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   */
  [_LOWER] = KEYMAP( \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   LGUI(KC_L), RCTL(RALT(KC_DELT)), KC_ASTR, KC_LPRN, KC_RPRN, KC_BKSP, \
