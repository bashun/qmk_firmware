...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  \   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Crtl+z| Esc  | GUI  | Alt  |Alt+` |Space | Bksp |RAISE |Enter |LOWER | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      LCTL(KC_Z), KC_ESC,  KC_LGUI, KC_LALT, LALT(KC_GRV), KC_SPC, KC_BSPC,  RAISE,   KC_ENT,  LOWER,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   */
  [_LOWER] = KEYMAP( \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   LGUI(KC_L), RCTL(RALT(KC_DELT)), KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC,    KC_AMPR,             KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, \
      KC_PSCR, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,      KC_UNDS,             KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
  ...
  [_RAISE] = KEYMAP( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
      KC_PSCR, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
