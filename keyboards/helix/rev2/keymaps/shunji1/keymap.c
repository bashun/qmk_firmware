...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * `-------------------------------------------------------------------------------------------------'
  ...
  [_LOWER] = KEYMAP( \
      ...
      _______, _______, _______, _______, KC_LCBR, KC_RCBR,                   LCTL(LALT(KC_DEL)), LGUI(KC_L), _______, KC_HOME, KC_END, KC_F12, \
      ...
      _______, _______, _______, KC_PGDN, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_DEL, \
        RESET, _______, _______, _______, _______, _______, KC_PSCR, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
  ),
